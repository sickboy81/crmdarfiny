...
export default function NewBroadcastPage() {
  ...
  const steps = [
    { label: t('stepTemplate'), key: 'template' },
    { label: t('stepAudience'), key: 'audience' },
    { label: t('stepPersonalize'), key: 'personalize' },
    { label: t('stepSend'), key: 'send' },
  ] as const;
  ...
  async function handleSaveDraft() {
    ...
    if (error) {
      toast.error(t('draftSaveFailed', { error: error.message }));
      return;
    }
