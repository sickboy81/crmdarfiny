...
export const SECTION_META: Record<SettingsSection, SectionMeta> = {
  ...
  fields: { id: 'fields', labelKey: 'fieldsAndTags', icon: Tags, group: 'workspace' },
  deals: { id: 'deals', labelKey: 'dealsAndCurrency', icon: Coins, group: 'workspace' },
  members: { id: 'members', labelKey: 'teamMembers', icon: UsersRound, group: 'workspace' },
  api: { id: 'api', labelKey: 'apiKeys', icon: KeyRound, group: 'workspace' },
};

export const RAIL_GROUPS: { labelKey: string | null; group: SectionMeta['group'] }[] = [
  { labelKey: null, group: 'top' },
  { labelKey: 'account', group: 'account' },
  { labelKey: 'workspace', group: 'workspace' },
];
