...
export function Step2SelectAudience({
  ...
  const OPERATOR_OPTIONS = useMemo(
    () => [
      { value: 'is' as CustomFieldOperator, label: t('operatorIs') },
      { value: 'is_not' as CustomFieldOperator, label: t('operatorIsNot') },
      { value: 'contains' as CustomFieldOperator, label: t('operatorContains') },
    ],
    [t],
  );
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-foreground">{t('selectAudienceTitle')}</h2>
